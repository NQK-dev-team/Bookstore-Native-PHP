...
**Step 7:** Update Hosts File, open this file as an administrator, this is where you can usually find the file `C:\Windows\System32\drivers\etc\hosts` (usually the case) and add these lines at the near bottom
