...
<head>
      ...
      <meta name="description" content="Recover lost admin account of NQK Bookstore">
...
<body>
      ...
      <section id="page">
            <div class="container-fluid h-100 d-flex justify-content-center py-4">
                  ...
                  <form onsubmit="enterCode(event)" class="bg-white border border-black rounded form my-auto flex-column px-3" id="recovery_code_form">
                        ...
                        <div class="d-flex align-items-center mt-3">
                              ...
                              <button type="button" class="btn btn-success btn-sm ms-2" onclick="requestRecoveryCode()">Request another</button>
                        </div>
            ...
            <div class="modal fade" id="passwordChangeModal" tabindex="-1" aria-labelledby="Password change modal">
