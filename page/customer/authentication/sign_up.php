...
<head>
      ...
      <meta name="description" content="Sign up to use NQK bookstore's services">
      <title>Sign up</title>
            ...
            <div class="container-fluid h-100 d-flex justify-content-center py-4">
                  <form onsubmit="signUpHandler(event)" class="bg-white border border-black rounded form my-auto d-flex flex-column px-3">
                        ...
                        <div class="form-group">
                              ...
                              <input autocomplete="on" type="text" required class="form-control" id="inputName" placeholder="Enter name" name="name">
                        </div>
                        ...
                        <div class="form-group mt-3">
                              ...
                              <input onchange="checkPhoneUsed()" autocomplete="on" type="tel" required class="form-control" id="inputPhone" placeholder="Enter phone number" name="phone" pattern="[0-9]{10}">
