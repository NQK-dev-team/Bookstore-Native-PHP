...
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK1', '200000.000', '0');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK2', '300000.000', '14');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK3', '400000.000', '14');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK4', '500000.000', '12');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK5', '150000.000', '15');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK6', '200000.000', '0');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK7', '300000.000', '15');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK8', '400000.000', '18');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK9', '500000.000', '11');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK10', '150000.000', '0');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK11', '200000.000', '25');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK12', '300000.000', '19');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK13', '400000.000', '4');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK14', '500000.000', '15');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK15', '150000.000', '20');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK16', '200000.000', '17');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK17', '300000.000', '21');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK18', '400000.000', '14');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK19', '500000.000', '10');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK20', '150000.000', '7');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK21', '200000.000', '15');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK22', '300000.000', '25');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK23', '400000.000', '14');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK24', '500000.000', '12');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK25', '150000.000', '17');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK26', '200000.000', '24');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK27', '300000.000', '14');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK28', '400000.000', '19');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK29', '500000.000', '0');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK30', '150000.000', '15');
INSERT INTO `bookstore`.`physicalcopy` (`id`, `price`, `inStock`) VALUES ('BOOK31', '200000.000', '18');
...
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK3', '139999.000', 'demo/BOOK3/Lord of Goblins, Vol. 1 Definitive Edition (Lord of Goblins).pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK4', '139999.000', 'demo/BOOK4/The Hitchhiker`s Guide to the Galaxy.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK5', '139999.000', 'demo/BOOK5/The Time Machine.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK6', '139999.000', 'demo/BOOK6/Pride and Prejudice.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK7', '139999.000', 'demo/BOOK7/To Kill a Mockingbird.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK8', '139999.000', 'demo/BOOK8/The Alchemist.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK9', '139999.000', 'demo/BOOK9/The Handmaid`s Tale.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK10', '139999.000', 'demo/BOOK10/Sapiens A Brief History of Humankind.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK11', '139999.000', 'demo/BOOK11/Dracula.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK12', '139999.000', 'demo/BOOK12/One Hundred Years of Solitude.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK13', '139999.000', 'demo/BOOK13/The Martian.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK14', '139999.000', 'demo/BOOK14/The Fault in Our Stars.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK15', '139999.000', 'demo/BOOK15/Things Fall Apart.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK16', '139999.000', 'demo/BOOK16/Murder on the Orient Express.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK17', '139999.000', 'demo/BOOK17/Dune.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK18', '139999.000', 'demo/BOOK18/The Lord of the Rings.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK19', '139999.000', 'demo/BOOK19/The Handmaid`s Tale.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK20', '139999.000', 'demo/BOOK20/Sapiens A Brief History of Humankind.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK21', '139999.000', 'demo/BOOK21/The Count of Monte Cristo.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK22', '139999.000', 'demo/BOOK22/Frankenstein.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK23', '139999.000', 'demo/BOOK23/The Hitchhiker`s Guide to the Galaxy.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK24', '139999.000', 'demo/BOOK24/1984.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK25', '139999.000', 'demo/BOOK25/The God of Small Things.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK26', '139999.000', 'demo/BOOK26/Echoes of Asgard.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK27', '139999.000', 'demo/BOOK27/Money Magic.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK28', '139999.000', 'demo/BOOK28/Code Red.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK29', '139999.000', 'demo/BOOK29/Whisper in the Wilds.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK30', '139999.000', 'demo/BOOK30/The Girl with the Timekeeper`s Heart.pdf');
INSERT INTO `bookstore`.`filecopy` (`id`, `price`, `filePath`) VALUES ('BOOK31', '139999.000', 'demo/BOOK31/Lord of Goblins, Vol. 2.pdf');
