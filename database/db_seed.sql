...
INSERT INTO `bookstore`.`author` (`bookID`, `authorIdx`, `authorName`) VALUES ('BOOK12', '1', 'Gabriel Garcia Marquez');
...
UPDATE `bookstore`.`book` SET `description` = 'The novel tells the story of the rise and fall of the mythical town of Macondo through the history of the Buendia family. Rich and brilliant, it is a chronicle of life, death, and the tragicomedy of humankind. In the beautiful, ridiculous, and tawdry story of the Buendia family, one sees all of humanity, just as in the history, myths, growth, and decay of Macondo, one sees all of Latin America.' WHERE (`id` = 'BOOK12');
...
UPDATE `bookstore`.`book` SET `description` = 'On the eve of his marriage to the beautiful Mercedes, having that very day been made captain of his ship, the young sailor Edmond Dantes is arrested on a charge of treason, trumped up by jealous rivals. Incarcerated for many lonely years in the isolated and terrifying Chateau d\'If near Marseille, he meticulously plans his brilliant escape and extraordinary revenge.' WHERE (`id` = 'BOOK21');
